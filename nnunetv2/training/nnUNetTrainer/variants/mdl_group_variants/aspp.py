...
class ASPP(nn.Module):
    def __init__(self, num_classes):
        ...
        self.bn_conv_1x1_1 = nn.InstanceNorm3d(256)

        self.conv_3x3_1 = nn.Conv3d(512, 256, kernel_size=3, stride=1, padding=4, dilation=4)
        self.bn_conv_3x3_1 = nn.InstanceNorm3d(256)

        self.conv_3x3_2 = nn.Conv3d(512, 256, kernel_size=3, stride=1, padding=8, dilation=8)
        self.bn_conv_3x3_2 = nn.InstanceNorm3d(256)

        self.conv_3x3_3 = nn.Conv3d(512, 256, kernel_size=3, stride=1, padding=12, dilation=12)
        self.bn_conv_3x3_3 = nn.InstanceNorm3d(256)

        self.avg_pool = nn.AdaptiveAvgPool3d(1)

        self.conv_1x1_2 = nn.Conv3d(512, 256, kernel_size=1)
        self.bn_conv_1x1_2 = nn.InstanceNorm3d(256)

        self.conv_1x1_3 = nn.Conv3d(1280, 256, kernel_size=1)
        self.bn_conv_1x1_3 = nn.InstanceNorm3d(256)
