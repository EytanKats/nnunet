...
def conv3x3(in_planes, out_planes, stride=1, dilation=1):
    ...
    return nn.Conv3d(in_planes, out_planes, kernel_size=3, stride=stride, padding=dilation, bias=False, dilation=dilation)
...
def resnet18(input_channels, **kwargs):
    model = ResNet(input_channels, _BasicBlock, [2, 2, 2, 2], **kwargs)
    return model


def resnet34(input_channels, **kwargs):
    model = ResNet(input_channels, _BasicBlock, [3, 4, 6, 3], **kwargs)
    return model


def resnet50(input_channels, **kwargs):
    model = ResNet(input_channels, _Bottleneck, [3, 4, 6, 3], **kwargs)
    return model


def resnet101(input_channels, **kwargs):
    model = ResNet(input_channels, _Bottleneck, [3, 4, 23, 3], **kwargs)
    return model


def resnet152(input_channels, **kwargs):
    model = ResNet(input_channels, _Bottleneck, [3, 8, 36, 3], **kwargs)
    return model
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, stride=1, dilation=1):
        ...
        if (stride != 1) or (in_channels != out_channels):
            ...
            bn = nn.InstanceNorm3d(out_channels)
