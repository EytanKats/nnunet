...
class nnUNetTrainer(object):
    def __init__(self, args, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
    ...
    def on_train_end(self):
        ...
        with open(os.devnull, 'w') as f:
            ...
            if self.dataloader_val is not None:
                if isinstance(self.dataloader_val, SingleThreadedAugmenter):
                    pass
                else:
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if not "NNUNET_DEBUG_FLAG" in os.environ:
